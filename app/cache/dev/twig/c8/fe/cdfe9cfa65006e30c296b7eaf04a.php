...
";
    ...
    public function block_col_left($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["im"]) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl(("bundles/vaxfront/images/servicios/mothers/" . $this->getContext($context, "im"))), "html", null, true);
