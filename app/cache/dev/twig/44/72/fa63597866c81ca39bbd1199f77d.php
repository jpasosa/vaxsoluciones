...
<html xmlns:fb=\"http://ogp.me/ns/fb#\"> <!-- agregado para facebook -->
    ...
    public function block_header($context, array $blocks = array())
    {
        ...
        echo "  <!-- Termina bloque sub-menu -->
                        ...
                        ";
        // line 140
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "homepage")) {
            // line 141
    ...
    public function block_menu($context, array $blocks = array())
    {
        ...
        echo "\"> Home </a> </li>
                                        <li> <a class=\"";
        // line 65
        if ((($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "nosotros") || ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "historia"))) {
            // line 66
            echo "active";
        }
        echo "\"
        ...
        echo "\"> Nosotros </a> </li>
                                        <li> <a class=\"";
        // line 68
        if ((((((($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "servicios") || ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "garantia")) || ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "notebook")) || ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "placavideo")) || ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "seguridad")) || ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "faq"))) {
            // line 73
            echo "active";
        }
        echo "\"
        ...
        echo "\"> Servicios </a> </li>
                                        <li> <a class=\"";
        // line 75
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "clientes")) {
            echo "active";
        }
        echo "\"
                                                        href=\"";
        ...
        echo "\"> Nuestros Clientes </a> </li>
                                        <li> <a class=\"";
        // line 77
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "ubiquiti")) {
            echo "active";
        }
        echo "\"
                                                        href=\"";
        ...
        echo "\"> Ubiquiti </a> </li>
                                        <li> <a class=\"";
        // line 79
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "ofertas")) {
            echo "active";
        }
        echo "\"
                                                        href=\"";
        ...
        echo "\"> Ofertas </a> </li>
                                        <li> <a class=\"";
        // line 81
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "contacto")) {
            echo "active";
        }
        echo "\"
                                                        href=\"";
    ...
    public function block_submenu($context, array $blocks = array())
    {
        ...
        if ((($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "nosotros") || ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "historia"))) {
            ...
            echo "                                  <div class=\"sub-nav\">
                                    <div>
                                      <ul class=\"sub-nav\">
                                        <li> <a class=\"";
            // line 95
            if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "nosotros")) {
                echo "active";
            }
            echo "\"
                                                        href=\"";
            ...
            echo "\"> Quienes Somos </a> </li>
                                        <li> <a class=\"";
            // line 97
            if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "historia")) {
                echo "active";
            }
            echo "\"
                                                        href=\"";
        ...
        echo "
                            ...
                            ";
        // line 110
        if (((((((($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "servicios") || ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "garantia")) || ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "seguridad")) || ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "placavideo")) || ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "notebook")) || ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "motherboard")) || ($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "faq"))) {
            // line 117
            echo "                                  <div class=\"sub-nav\">
                                    <div>
                                      <ul class=\"sub-nav\">
                                        <li> <a class=\"";
            // line 120
            if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "garantia")) {
                echo "active";
            }
            echo "\"
                                                        href=\"";
            ...
            echo "\"> Motherboard </a> </li>
                                        <li> <a class=\"";
            // line 124
            if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "notebook")) {
                echo "active";
            }
            echo "\"
                                                        href=\"";
            ...
            echo "\"> Notebook </a> </li>
                                        <li> <a class=\"";
            // line 126
            if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "placavideo")) {
                echo "active";
            }
            echo "\"
                                                        href=\"";
            ...
            echo "\"> Placa de Video </a> </li>
                                        <li> <a class=\"";
            // line 128
            if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "seguridad")) {
                echo "active";
            }
            echo "\"
                                                        href=\"";
            ...
            echo "\"> Seguridad </a> </li>
                                        <li> <a class=\"";
            // line 130
            if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "faq")) {
                echo "active";
            }
            echo "\"
                                                        href=\"";
    ...
    public function block_body($context, array $blocks = array())
    {
        ...
        if (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "contacto")) {
            ...
            echo "                            </div>
                    ";
        } elseif (($this->getAttribute($this->getAttribute($this->getContext($context, "app"), "request"), "get", array(0 => "_route"), "method") == "ofertas")) {
            // line 165
    ...
    {
        return array (  532 => 179,  529 => 178,  525 => 168,  522 => 167,  518 => 163,  515 => 162,  509 => 194,  505 => 192,  503 => 191,  500 => 190,  496 => 188,  492 => 186,  490 => 185,  484 => 181,  482 => 178,  479 => 177,  475 => 175,  471 => 173,  469 => 172,  466 => 171,  461 => 169,  459 => 167,  455 => 165,  451 => 164,  449 => 162,  444 => 160,  441 => 159,  438 => 158,  433 => 136,  425 => 131,  419 => 130,  415 => 129,  409 => 128,  405 => 127,  399 => 126,  395 => 125,  389 => 124,  385 => 123,  379 => 122,  375 => 121,  369 => 120,  364 => 117,  362 => 110,  353 => 103,  345 => 98,  339 => 97,  335 => 96,  329 => 95,  324 => 92,  322 => 90,  316 => 88,  307 => 82,  301 => 81,  297 => 80,  291 => 79,  287 => 78,  281 => 77,  277 => 76,  271 => 75,  267 => 74,  262 => 73,  260 => 68,  256 => 67,  251 => 66,  249 => 65,  245 => 64,  239 => 63,  231 => 59,  226 => 153,  216 => 148,  210 => 147,  204 => 146,  198 => 145,  192 => 144,  187 => 141,  185 => 140,  180 => 137,  178 => 88,  175 => 87,  173 => 59,  167 => 56,  163 => 54,  160 => 53,  150 => 29,  146 => 28,  142 => 27,  138 => 26,  135 => 25,  132 => 24,  126 => 20,  122 => 19,  117 => 17,  113 => 16,  108 => 15,  105 => 14,  100 => 9,  97 => 8,  91 => 204,  89 => 203,  81 => 197,  79 => 158,  73 => 154,  71 => 53,  51 => 35,  49 => 24,  45 => 22,  43 => 14,  38 => 11,  36 => 8,  27 => 1,);
    }
}
