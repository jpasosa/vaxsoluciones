...
";
    ...
    public function block_col_left($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["im"]) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl(("bundles/vaxfront/images/servicios/videos/" . $_im_)), "html", null, true);
...
";
    ...
    {
        return array (  65 => 21,  55 => 19,  50 => 18,  38 => 8,  35 => 7,  30 => 4,  27 => 3,);
    }
}
