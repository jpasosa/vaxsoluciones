...
";
    ...
    public function block_col_left($context, array $blocks = array())
    {
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["im"]) {
            ...
            echo twig_escape_filter($this->env, $this->env->getExtension('assets')->getAssetUrl(("bundles/vaxfront/images/nosotros/" . $_im_)), "html", null, true);
...
";
    ...
    {
        return array (  68 => 22,  64 => 20,  54 => 18,  49 => 17,  38 => 8,  35 => 7,  30 => 4,  27 => 3,);
    }
}
